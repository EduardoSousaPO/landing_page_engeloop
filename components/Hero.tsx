  ...
  const handleWhatsAppClick = (label: string) => {
    if (typeof gtag !== 'undefined') {
      gtag('event', 'conversion', {
        ...
        'event_label': `whatsapp_hero_${label}`
      })
    }
  }
          ...
          <div className="heroContent">
            ...
            <div className="heroBenefits">
              ...
              <div className="heroBenefitItem">
                ...
                <span>Atendimento em Todo o País</span>
              </div>
            </div>
            <div className="heroButtons">
              <a
                ...
                className="btnPrimary btnLarge heroCtaPrimary"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btnWhatsApp btnLarge heroCtaWhatsApp"
            ...
            <p className="heroTrustText">
              ...
              Resposta em até 1 hora • Orçamento sem compromisso
            </p>
          </div>
        </div>
      </div>
